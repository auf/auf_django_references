...
class Region(models.Model):
    ...
    nom = models.CharField(max_length=255)
    implantation_bureau = models.ForeignKey('Implantation', db_column='implantation_bureau', related_name='gere_region')
    # meta
    actif = models.BooleanField()
...
class Etablissement(models.Model):
    ...
    region = models.ForeignKey('Region', db_column='region')
    implantation = models.ForeignKey('Implantation', db_column='implantation', related_name='gere_etablissement')
    code_implantation = models.ForeignKey('Implantation', to_field='code', db_column='code_implantation', related_name='code_gere_etablissement')
    # membership
